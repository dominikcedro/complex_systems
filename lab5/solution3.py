...
if __name__ == "__main__":
    ...
    degree_distribution, average_degree, clustering_coeffs, average_clustering_coeff, path_lengths, diameter, average_path_length = calculate_properties(
        G)

    N = 100
    p = 0.05
    G_gnp = erdos_renyi_gnp(N, p)
    degree_distribution_gnp, average_degree_gnp, clustering_coeffs_gnp, average_clustering_coeff_gnp, path_lengths_gnp, diameter_gnp, average_path_length_gnp = calculate_properties(
        G_gnp)
    ...
    degree_distribution_ws, average_degree_ws, clustering_coeffs_ws, average_clustering_coeff_ws, path_lengths_ws, diameter_ws, average_path_length_ws = calculate_properties(
        G_ws)
